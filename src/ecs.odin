...
ecs_add_light :: proc(entity: Entity, light_type: Light_Type, color: [3]f32, intensity, range: f32) -> ^Light {
    light := Light{
        base = Component{
            type = .LIGHT,
            entity = entity,
...
ecs_has_component :: proc(entity: Entity, component_type: Component_Type) -> bool {
    #partial switch component_type {
        case .TRANSFORM: return entity in entity_manager.transforms
        case .RENDERER:  return entity in entity_manager.renderers
        case .CAMERA:    return entity in entity_manager.cameras
        case .LIGHT:     return entity in entity_manager.lights
        case .SCRIPT:    return entity in entity_manager.scripts
        case:            return false
    }
}

// Get all entities that have a specific component
ecs_get_entities_with_component :: proc(component_type: Component_Type, allocator := context.allocator) -> []Entity {
...
ecs_get_entities_with_components :: proc(type1, type2: Component_Type, allocator := context.allocator) -> []Entity {
